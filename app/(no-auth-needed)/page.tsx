  ...
  return (
    <main className='overflow-x-hidden'>
        <section className="grid lg:grid-cols-2 h-screen gap-5 w-11/12 mx-auto ">
            ...
            <div className='relative flex items-center justify-center '>
                <Image alt="Dashboard de Kairos" 
                    ...
                    className=" border-8 border-black rounded-md shadow-blue-shadow bg-green-light  absolute rotate-[345deg] transform translate-x-24 translate-y-1 2xl:translate-y-[-5rem]"
                >
        ...
        <section className='h-[50vh] w-4/5 mx-auto flex flex-col items-center justify-center '>
            <h1 className='text-center text-4xl 2xl:text-5xl py-14'>En Phronesis puedes </h1>
            <div className='grid lg:grid-cols-5 gap-7 grid-cols-2'>
                <div className='flex flex-col items-center'>
                    <Image src="/landing/comparar.png" width={140} height={140} alt="Comprar tokens al instante" />
                    <span>Comprar tokens al instante</span>
                </div>
                <div className='flex flex-col items-center'>
                    <Image src="/landing/control.png" width={140} height={140} alt="control total de tus activos" />
                    <span>Control Total de tus Activos</span>
                </div>
                <div className='flex flex-col items-center'>
                    <Image src="/landing/analisis.png" width={140} height={140} alt="Analizar Proyectos a Fondo" />
                    <span>Analizar Proyectos a Fondo</span>
                </div>
                <div className='flex flex-col items-center'>
                    <Image src="/landing/check.png" width={140} height={140} alt="Ver toda tu información en un solo lugar" />
                    <span className='text-center'>Ver toda tu información en un solo lugar</span>
                </div>
                <div className='flex flex-col items-center'>
                    <Image src="/landing/decision.png" width={140} height={140} alt="Tomar decisiones Rápidas e Informadas" />
                    <span className='text-center'>Tomar decisiones Rápidas e Informadas</span>
                </div>
        ...
        <section   className='h-[50vh] w-4/5 mx-auto gap-16  grid lg:grid-cols-2'>
            ...
            <div  className='flex flex-col items-center justify-center'>
                <Image src={'/landing/multiples-wallets.png'} alt="monitorear multiples wallets"
                 width={600} height={450} 
                 />
            </div>
            <div className='flex flex-col items-center justify-center'>
            <h1 className='text-4xl 2xl:text-5xl mb-14'>Monitorea multiples Wallets</h1>
        ...
        <section className='h-[50vh] w-4/5 mx-auto gap-16  grid lg:grid-cols-2'>
        <div className='flex flex-col items-center justify-center'>
            <h1 className='text-4xl 2xl:text-5xl mb-14'>Compara tokens</h1>
            <p className='tracking-wide text-lg'>
            ...
            <div  className='flex flex-col items-center justify-center'>
                <Image src={'/landing/comparar-tokens.png'} alt="monitorear multiples wallets" width={600} height={450} />
            </div>
        </section>
        <section  className='h-[50vh] w-4/5 mx-auto gap-16  grid lg:grid-cols-2'>

        <div  className='flex flex-col items-center justify-center'>
                <Image src={'/landing/analisis-image.png'} alt="monitorear multiples wallets" width={700} height={650} />
            </div>
        <div className='flex flex-col items-center justify-center'>
        ...
        <div className='dark:bg-hero-pattern bg-no-repeat md:bg-cover'>
            ...
            <h1 className='text-4xl 2xl:text-5xl mb-32'>
...
{/* //  shadow-blue-shadow bg-gradient-to-b from-green-light/40 to-[#00FFFF98] */}
        ...
        <section className='w-4/5 mx-auto h-[40vh] mb-20 flex flex-col  items-center justify-center'>
            <h1 className='text-center text-4xl 2xl:text-5xl py-14 mb-20'>Validados por:</h1>
            <div className="grid lg:grid-cols-6 w-full gap-10 2xl:gap-28 ">
                <Image src="/landing/Colledge.png" width={85} height={85} alt='Colledge'/>
                <Image src="/landing/Makers.png" width={85} height={85} alt='makers'/>
                <Image src="/landing/Celo.png" width={85} height={85} alt='celo'/>
                <Image src="/landing/retro_pgf.png" width={85} height={85} alt='Retro'/>
                <Image src="/landing/Metapool.png" width={85} height={85} alt='Metapool'/>
                <Image src="/landing/pbs_foundation.png" width={85} height={85} alt='Pbs foundation'/>
        ...
        <section className='w-4/5 mx-auto h-[70vh] flex flex-col items-center justify-center'>
            <h1 className='text-center text-4xl 2xl:text-5xl mb-20 py-14'>Nuestros primeros usuarios opinan</h1>
            <div className="grid lg:grid-cols-3 w-full gap-10 2xl:gap-28  ">
        ...
        <section className='w-4/5 mb-20 mx-auto flex flex-col items-center h-[70vh] justify-center'>
            <h1 className='text-center text-4xl 2xl:text-5xl py-14 mb-20'>Preguntas frecuentes:</h1>
            <div className=' w-3/5'>
            <Card className='bg-[#393939] px-12'>
                <CardContent>
                    <Accordion type="multiple">
                        <AccordionItem value="item-1">
                            <AccordionTrigger>¿Qué es Phronesis?</AccordionTrigger>
                            <AccordionContent>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                            <AccordionTrigger>¿Qué beneficios obtengo al suscribirme a Phronesis?</AccordionTrigger>
                            <AccordionContent>Phasellus imperdiet, nulla et dictum interdum, nisi lorem egestas odio.</AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                            <AccordionTrigger>¿Phronesis está disponible en varios idiomas?</AccordionTrigger>
                        ...
                        <AccordionItem value="item-4">
                            <AccordionTrigger>¿Cómo se monitorean varias wallets en Phronesis?</AccordionTrigger>
        ...
        <section className='w-4/5  mx-auto flex flex-col items-center justify-around pb-52'>
            ...
            <div className="grid grid-cols-4 gap-10 mb-20">
                <div className="flex flex-col items-center justify-center">
                    <Image alt="Persona del team" height={400} width={150} src="/landing/team_pics_ariel.png" />
                ...
                <div className="flex flex-col items-center justify-center">
                    <Image alt="Persona del team" height={400} width={150} src="/landing/team_pics_jorge.png" />
                    <p>
                        Jorge Magni
                    </p>
                    <p className='text-sm mt-0 text-green-dark'>
                ...
                <div className="flex flex-col items-center justify-center">
                    <Image alt="Persona del team" height={400} width={150} src="/landing/team_pics_ale.png" />
                    <p>
                        Alejandro Ramos
                    </p>
                    <p className='text-sm mt-0 text-green-dark'>
                ...
                <div className="flex flex-col items-center justify-center">
                    <Image alt="Persona del team" height={500} width={150} src="/landing/team2.png" />
                    <p>
                        Sergio
                    </p>
                    <p className='text-sm mt-0 text-green-dark'>
